...
import ru.mirea.rudenok.mireaproject.databinding.FragmentWeatherBinding;
...
public class WeatherFragment extends Fragment {
    ...
    private class DownloadPageTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            binding.getweather.setText("Загрузка...");
        }
        @Override
        ...
        protected void onPostExecute(String result) {
            ...
            binding.temp.setText(String.format("Температура -  %s °C", temp));
            binding.wind.setText(String.format("Ветер -  %s м/с", wind));

            binding.getweather.setText("Получить прогноз");
